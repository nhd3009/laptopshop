                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/update"
                                                modelAttribute="currProduct" enctype="multipart/form-data">
                                                <c:set var="errorName">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label col-12 col-md-6">Detail
                                                        description:</label>
                                                    <form:input type="text"
                                                ...
                                                <div class="mb-3">
                                                    <img style="max-height: 250px;" alt="avatar preview"
                                                        src="/images/product/${currProduct.image}" id="avatarPreview">
                                                </div>
